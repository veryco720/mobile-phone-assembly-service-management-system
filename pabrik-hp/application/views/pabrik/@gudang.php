<script>
    ...
    var material = {
        ...
        FilterValue: ko.observable('id_gudang'),

        SELECTPRODUK: ko.observableArray([]),

        SELECTFILTERVALUE: [
            { name: 'id_gudang', value: 'id_gudang' },
                        ...
                        <div class="tab-pane active" id="tabform">
                            <div class="card card-primary">
                                <div class="card-body p-20 animated fadeIn">
                                        ...
                                        <div class="col-md-12 margMin">
                                            <div class="form-group">
                                                ...
                                                <button class="btn btn-sm btn-danger"
                                                    data-bind="click: function(){ remove(Recordmaterial.id_gudang()); }, visible: Mode() == 'Update'">
                                    ...
                                    <div class="form-group" data-bind="with: Recordmaterial">
                                        <label for="inputstok">stok_produk</label>
                                    ...
                                    <div class="form-group" data-bind="with: Recordmaterial">
                                        <label for="inputtanggalupdate">tanggal_update</label>
