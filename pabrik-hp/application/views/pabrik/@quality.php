<script>
    ...
    var material = {
        ...
        Mode: ko.observable(''),
        DataFilter: ko.observableArray(['id_produksi']),
    ...
    material.selectdata = function(id) {
        ...
        ajaxPost("<?php echo site_url('contoh/QualityController/getDataSelect') ?>", {
            id: id
        }, function(res) {
            console.log(res[0]);
            material.back(0);
    ...
    material.loadProduksi = function () {
        $.ajax({
            url:  "<?php echo site_url('pabrik/QualityController/getProduksi') ?>", // sesuaikan nama controller
            type: "GET",
            dataType: "json",
    ...
    material.loadKaryawan = function () {
        $.ajax({
            url:  "<?php echo site_url('pabrik/QualityController/getKaryawan') ?>", // sesuaikan nama controller
            type: "GET",
            dataType: "json",
            success: function (res) {
                console.log(res)
                                ...
                                <div class="card-body p-20 animated fadeIn m">
                                    ...
                                    <div class="card-body" data-bind="with:Recordmaterial">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="hasil_qc" name="hasil_qc" class="form-control" data-bind="value:hasil_qc" placeholder="Masukkan HASIL QC">I am a comment</textarea>

                                        </div>
                                        <div class="form-group">
                                            <label for="catatan">catatan</label>
                                            <textarea id="catatan" name="catatan" class="form-control" data-bind="value:catatan" placeholder="Masukkan CATATAN">I am a comment</textarea>

                                        </div>
                                        <div class="form-group">
                                            <label for="tanggal_qc">tanggal_qc</label>
                                            <input type="date" name="tanggal_qc" class="form-control" data-bind="value:tanggal_qc" id="tanggal_qc" placeholder="Masukkan TANGGAL QC">
                                        </div>
                                    </div>
                                </div>
                            </div>
